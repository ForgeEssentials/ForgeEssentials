...
public class Point {
	...
	/**
	 * Checks if two points are on the same plane (have the same coordinate on at
	 * least one axis)
	 */
	...
	/**
	 * Checks if this point has greater or equal coordinates than another point on
	 * all axes
	 */
	...
	/**
	 * Checks if this point has less or equal coordinates than another point on all
	 * axes
	 */
