...
public final class Translator
{
    ...
    public static final File translationFile = new File("./ForgeEssentials/" + TRANSLATOR_FILE);
    ...
    {
        File file = new File(translationFile, TRANSLATOR_FILE);
        ...
        {
            Utils.felog.error("Error writing translation file.");
        }
    }
    ...
    public static void load()
    {
        ...
        {
            Utils.felog.warn("Error loading translation file.");
        }
    }
}
