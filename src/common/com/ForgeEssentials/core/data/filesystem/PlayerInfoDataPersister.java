...
/**
 * This DataPersister is responsible for saving PlayerInfo objects to a flat-file data backing.
 * 
 * @author MysteriousAges
 *
 */
public class PlayerInfoDataPersister extends FileSystemDataPersister<PlayerInfo>
{
	private String dataDir;
	
	public PlayerInfoDataPersister(String baseFilePath)
	{
	...
	@Override
	public void saveData(PlayerInfo object)
	{
	...
	@Override
	public void loadData(Object loadingKey, PlayerInfo object)
	{		
		if (loadingKey instanceof String)
		{
			String username = (String)loadingKey;
