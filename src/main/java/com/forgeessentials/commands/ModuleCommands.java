...
public class ModuleCommands implements ConfigLoader
{
	...
	public void load(Builder BUILDER, boolean isReload) {
    	...
    	FECFBdefaultRange = BUILDER.comment("Default max distance used.").defineInRange("defaultRange", 20 * 16, 0, Integer.MAX_VALUE);
    	FECFBdefaultSpeed = BUILDER.comment("Default speed used.").defineInRange("defaultSpeed", 16 * 16, 0, Integer.MAX_VALUE);
        BUILDER.pop();
        ...
        FEHentriesPerPage = BUILDER.comment("Amount to commands to show per help page")
                .defineInRange("commandPerPage", 8, 1, 50);
        FEHcommandColor = BUILDER.comment("Color for the command in /help. The possible values are; "
        ...
        FEHsubCommandColor = BUILDER.comment("Color for the subcommand in /help. The possible values are; "
                + "0: black, 1: dark_blue, 2: dark_green, 3: dark_aqua, 4: dark_red, "
                + "5: dark_purple, 6: gold, 7: gray, 8: dark_gray, 9: blue, "
                + "10: green, 11: aqua, 12: red, 13: light_purple, 14: yellow, 15: white.")
