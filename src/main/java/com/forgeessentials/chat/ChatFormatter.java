...
public class ChatFormatter
{
	...
	public void chatEvent(ServerChatEvent event)
	{
	    ...
	    {
	        ModuleChat.chatLog.printf(FunctionHelper.getCurrentDateString() + " " + FunctionHelper.getCurrentTimeString() + "[" + event.username + "] " + event.message); // don't use event.line - it shows colour codes and everything
	    }
