...
public interface RemoteManager {
	...
	public static class DefaultRemoteHandlerManager implements RemoteManager {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.forgeessentials.api.remote.RemoteManager#registerHandler(com.
		 ...
		 * 
		 * @see
		 * com.forgeessentials.api.remote.RemoteManager#getHandler(java.lang.String)
		 */
		@Override
		 ...
		 * 
		 * @see
		 * com.forgeessentials.api.remote.RemoteManager#convertJsonObject(com.google.
		 * gson.JsonObject, java.lang.Class)
		 */
		@Override
		public Gson getGson() {
			return null;
