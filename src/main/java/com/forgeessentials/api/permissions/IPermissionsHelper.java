...
/**
 * {@link IPermissionsHelper} is the primary access-point to the
 * permissions-system.
 */
public interface IPermissionsHelper extends IPermissionHandler {
	 ...
	 * 
	 * @param permissionNode
	 * @param description    Description for the permission. Description will be
	 *                       stored as "permissionNode.$desc" permission-property.
	 */
	 ...
	 * 
	 * @param permissionNode
	 * @param level          Default level of the permission. This can be used to
	 *                       tell the underlying {@link IPermissionHandler} whether
	 *                       a player should be allowed to access this permission by
	 *                       default, or as operator only.
	 * @param description    Description for the permission.
	 */
	...
	/**
	 * Returns a zone by it's ID as string. It the string is no valid integer, it
	 * returns null.
	 * 
	 * @return Zone or null
	 */
	...
	/**
	 * Get all groups the player belongs to, together with the system- and included
