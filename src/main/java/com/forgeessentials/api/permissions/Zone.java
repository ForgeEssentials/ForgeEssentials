...
public abstract class Zone {
	...
	/**
	 * Gets the player permissions for the specified player. If no permission-map is
	...
	/**
	 * Gets the group permissions for the specified group. If no permission-map is
	 * present, a new one is created.
	 * 
	 * @param group Group
	 */
