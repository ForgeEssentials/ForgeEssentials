...
public class PortalManager extends ServerEventHandler {
	...
	public PortalManager() {
		...
		/*
		 * mixinLoaded =
		 * FEMixinConfig.getInjectedPatches().contains("block.MixinBlockPortal"); if
		 * (!mixinLoaded) { LoggingHandler.felog.
		 * error("Unable to apply portal block mixin. Will revert to glass panes for portals."
