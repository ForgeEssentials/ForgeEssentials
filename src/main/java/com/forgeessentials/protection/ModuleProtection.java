...
public class ModuleProtection {
	 ...
	 * 
	 * Container abstractContainer = inventory; if (abstractContainer instanceof
	 * PlayerContainer) { PlayerContainer container = (PlayerContainer)
	 * abstractContainer; return container.; } else if (abstractContainer instanceof
	 * WorkbenchContainer) { CraftingResultSlot slot = (CraftingResultSlot)
	 * abstractContainer.getSlot(0); return slot.player; } return null; }
	 */
