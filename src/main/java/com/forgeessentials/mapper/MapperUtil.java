...
//                    continue;
//                Chunk chunk = loadOrCreateChunk(world, cx, cz);
...
//    }
//
//    public static Chunk loadOrCreateChunk(ServerWorld world, int cx, int cz) {
//        Chunk chunk = null;
//        IChunk ichunk = world.getChunk(cx, cz, ChunkStatus.FULL, false);
//
...
//            ChunkManager chunkManager = chunkSource.chunkMap;
//            ChunkPos chunkPos = new ChunkPos(cx, cz);
//            
//            try
//            {
//                Method getVisibleChunkIfPresentMethod = ChunkManager.class.getDeclaredMethod("getVisibleChunkIfPresent", long.class);
//                getVisibleChunkIfPresentMethod.setAccessible(true);
//                ChunkHolder chunkHolder = (ChunkHolder) getVisibleChunkIfPresentMethod.invoke(chunkManager, chunkPos.toLong());
//                if (chunkHolder != null) {
//                    CompletableFuture<Either<IChunk, ChunkHolder.IChunkLoadingError>> future = chunkHolder.getFutureIfPresent(chunkHolder.getLastAvailableStatus());
//                    future.thenAccept(either -> {
//                        if (either.left().isPresent()) {
//                            // Chunk is now loaded in memory, and will be generated by the server when it has available resources
//                        }
//                    });
//                }
//            }
...
//            }
//            
//            ichunk = world.getChunk(cx, cz, ChunkStatus.FULL, false);
//            if (ichunk instanceof Chunk) {
//                return (Chunk) ichunk;
//            }
//        }
