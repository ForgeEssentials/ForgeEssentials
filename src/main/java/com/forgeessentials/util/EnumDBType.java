...
public enum EnumDBType {
	...
	/**
	 * @param isRemote      if the JDBC connection method should use the one with
	 *                      username and password or not.
	 * @param driverName    the qualified name of the JDBC connector class for this
	 *                      DB
	...
	/**
	 * loads the class used to load this database. Catches its own error and outputs
	 * it.
	 */
