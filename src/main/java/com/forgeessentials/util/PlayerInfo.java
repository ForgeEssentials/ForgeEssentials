...
public class PlayerInfo implements Loadable {
	...
	public void setInventoryGroup(String name) {
		if (!activeInventoryGroup.equals(name)) {
			 ...
			 * ItemStack.EMPTY) ChatOutputHandler.felog.info("  " +
			 * itemStack.getDisplayName()); }
			 * ChatOutputHandler.felog.info("Items in new inventory:"); for (ItemStack
			 * itemStack : newInventory) if (itemStack != ItemStack.EMPTY)
