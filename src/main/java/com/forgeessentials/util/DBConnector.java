...
public class DBConnector {
	 ...
	 * @param fallback      The DBConnector from which to take information for a
	 *                      given type if loading that type from this config fails.
	 * @param defaultType   the default database type to use
	 ...
	 */
	public DBConnector(String name, DBConnector fallback, EnumDBType defaultType, String dbDefault,
			String dbFileDefault, boolean useFallback) {
		this.name = name;
	...
	/**
	 * Forcibly writes everything to the config. the config's save() method is not
	 * called.
	 *
	 * @param config
	 * @param category the category where everything regarding this connector will
	 *                 be.
	 */
	...
	/**
	 * Loads the the connector from the config for use. config load method is not
	 * called.
	 *
	 * @param config
	 * @param category the category where everything regarding this connector will
