...
/**
 * All events on this class are fired on the FE internal EventBus and are not
 * cancellable.
 */
public class FEPlayerEvent extends PlayerEvent {
	...
	/**
	 * Fired when a player does not have PlayerInfo data, should modules need to do
	 * additional setup.
	 */
	...
	/**
	 * Fired when the AFK system declares a player has gone AFK. Thrown by commands
	 * module.
	 */
