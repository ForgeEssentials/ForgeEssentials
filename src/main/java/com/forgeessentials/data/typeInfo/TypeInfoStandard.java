    ...
    public TypeData getTypeDataFromObject(Object objectSaved)
    {
        ...
        catch (Exception e)
        {
            OutputHandler.exception(Level.SEVERE,
                    "Reflection error trying to get UniqueLoadingKey from " + objectSaved.getClass() + ". FE will continue without saving this.", e);
        }
        ...
        for (int i = 0; i < keys.length; ++i)
        {
            ...
            catch (NoSuchFieldException e)
            {
                ...
                if (currentClass == null)
                {
                    ...
                    OutputHandler
                            .exception(Level.SEVERE, "Reflection error trying to save " + objectSaved.getClass() + ". FE will continue without saving this.",
                                    e);
                }
                --i;
            }
            catch (Exception e)
            {
                ...
                OutputHandler
                        .exception(Level.SEVERE, "Reflection error trying to save " + objectSaved.getClass() + ". FE will continue without saving this.", e);
            }
        }
