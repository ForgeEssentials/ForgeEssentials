...
public class CommandWorldBorder extends ForgeEssentialsCommandBuilder
{
        		...
        		.then(Commands.argument("world", DimensionArgument.dimension())
                		...
                		.then(Commands.literal("size")
                				...
                				.then(Commands.literal("set")
                						...
                						.then(Commands.literal("XandZ")
                								.then(Commands.argument("x-radius", IntegerArgumentType.integer())
                										.then(Commands.argument("z-radius", IntegerArgumentType.integer())
                                                                .executes(CommandContext -> execute(CommandContext, "size-indiv")
                                                                        )
                                                                )
                                                        )
                                                )
                		...
                		.then(Commands.literal("effect")
                				...
                				.then(Commands.literal("add")
                						...
                						.then(Commands.literal("add")
                								.then(Commands.argument("TriggerDistance", IntegerArgumentType.integer())
                										.then(Commands.literal("block")
                                                                .executes(CommandContext -> execute(CommandContext, "effect-add-block")
                                                                        )
                                                                )
                										.then(Commands.literal("command")
                												.then(Commands.argument("interval", IntegerArgumentType.integer())
                														.then(Commands.argument("command", StringArgumentType.greedyString())
                        		                                                .executes(CommandContext -> execute(CommandContext, "effect-add-command")
                        		                                                        )
                        		                                                )
                		                                                )
                                                                )
                										.then(Commands.literal("damage")
                												.then(Commands.argument("timeout", IntegerArgumentType.integer())
                														.then(Commands.argument("damage", IntegerArgumentType.integer())
                        		                                                .executes(CommandContext -> execute(CommandContext, "effect-add-damage")
                        		                                                        )
                        		                                                )
                		                                                )
                                                                )
                										.then(Commands.literal("kick")
                												.then(Commands.argument("timeout", IntegerArgumentType.integer())
                		                                                .executes(CommandContext -> execute(CommandContext, "effect-add-kick")
                		                                                        )
                		                                                )
                                                                )
                										.then(Commands.literal("knockback")
                                                                .executes(CommandContext -> execute(CommandContext, "effect-add-knockback")
                                                                        )
                                                                )
                										.then(Commands.literal("message")
                												.then(Commands.argument("interval", IntegerArgumentType.integer())
                														.then(Commands.argument("message", StringArgumentType.greedyString())
                        		                                                .executes(CommandContext -> execute(CommandContext, "effect-add-message")
                        		                                                        )
                        		                                                )
                		                                                )
                                                                )
                				...
                				.then(Commands.literal("remove")
                						.then(Commands.argument("index", IntegerArgumentType.integer())
                                                .executes(CommandContext -> execute(CommandContext, "effect-remove")
                                                        )
                                                )
                                        )
                                )
    ...
    public static void parseCenter(CommandContext<CommandSource> ctx, WorldBorder border, String params) throws CommandSyntaxException
    {
    ...
    public static void parseRadius(CommandContext<CommandSource> ctx, WorldBorder border, String params) throws CommandSyntaxException
    {
    ...
    public static void parseShape(CommandContext<CommandSource> ctx, WorldBorder border, String params) throws CommandSyntaxException
    {
    ...
    public static void addEffect(CommandContext<CommandSource> ctx, WorldBorder border, String params) throws CommandSyntaxException
    {
        ...
        if (params.equals("effect-add-list"))
        {
            ...
            ChatOutputHandler.chatError(ctx.getSource(),"block, command, damage, kick, knockback, message, potion, smite");
            return;
        }
