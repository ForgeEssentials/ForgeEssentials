...
public class Session implements Runnable, RemoteSession {
	 ...
	 * 
	 * @see
	 * com.forgeessentials.api.remote.RemoteSession#sendMessage(java.lang.Object)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.forgeessentials.api.remote.RemoteSession#transformRemoteRequest(com.
	 * forgeessentials.api.remote.RemoteRequest, java.lang.Class)
	 */
	@Override
