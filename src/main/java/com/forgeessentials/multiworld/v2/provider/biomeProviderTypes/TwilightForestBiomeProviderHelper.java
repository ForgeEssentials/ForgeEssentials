...
@FEBiomeProvider(providerName = "twilightforest:grid")
public class TwilightForestBiomeProviderHelper extends BiomeProviderHolderBase {
	@Override
	...
	public String getClassName() {
		return "twilightforest.world.TFBiomeProvider";
	}
}
