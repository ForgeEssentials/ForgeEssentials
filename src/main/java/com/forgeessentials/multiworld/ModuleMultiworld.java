...
public class ModuleMultiworld// extends ConfigLoaderBase
{
     ...
     * 
     * FECommandManager.registerCommand(new CommandMultiworld()); FECommandManager.registerCommand(new CommandMultiworldTeleport()); } catch (java.lang.NoSuchMethodError
     ...
     * 
     * @SubscribeEvent public void serverStarting(FEModuleServerStartingEvent e) { multiworldManager.load();
     * 
     * PermissionAPI.registerNode(PERM_MANAGE, DefaultPermissionLevel.OP, "Manage multiworlds"); PermissionAPI.registerNode(PERM_DELETE, DefaultPermissionLevel.OP,
     * "Delete multiworlds"); PermissionAPI.registerNode(PERM_LIST, DefaultPermissionLevel.ALL, "List multiworlds on the server"); }
     * 
     * @SubscribeEvent public void serverStopped(FEModuleServerStoppedEvent e) { multiworldManager.serverStopped(); }
     * 
     * @Override public void load(Configuration config, boolean isReload) { // persistenceBackend = config.get(CONFIG_CAT, "persistenceBackend", "flatfile", //
     * "Choose a permission persistence backend (flatfile, sql)").getString(); }
     * 
     * public static MultiworldManager getMultiworldManager() { return multiworldManager; }
     */
