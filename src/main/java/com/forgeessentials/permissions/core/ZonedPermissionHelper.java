...
public class ZonedPermissionHelper extends ServerEventHandler implements IPermissionsHelper, PermissionDebugger {
	...
	/**
	 * First time that permissions have been changed. At least one minute after this
	 * time, permissions will definitely be saved.
	 */
	protected long firstDirtyTime = 0;

	/**
	 * Last time that permissions have been changed. Five seconds after no more
	 * permissions have been changed, they will be saved.
	 */
	...
	/**
	 * Main function for permission retrieval. This method should not be used
	 * directly. Use the helper methods instead.
	 *
	 * @param point
	 * @param groups
