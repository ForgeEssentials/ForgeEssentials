 ...
 * The handling performed here is limited to basic area permissions checks, and
...
public final class PermissionsPlayerHandler {
    ...
    {
        boolean isOp = MinecraftServer.getServer().getConfigurationManager().func_152596_g(event.doer.getGameProfile());
