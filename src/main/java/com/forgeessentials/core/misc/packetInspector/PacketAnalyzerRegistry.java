...
public class PacketAnalyzerRegistry {
    ...
    {
        return FEPacketAnalyzer.MemoryConnection_addToSendQueue && FEPacketAnalyzer.MemoryConnection_processOrCachePacket
                && FEPacketAnalyzer.TcpConnection_addToSendQueue && FEPacketAnalyzer.TcpConnection_readPacket;
    }
