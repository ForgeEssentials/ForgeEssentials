...
public class MixinCommands
{
	  /**
	   * @author maximuslotro
	   * @reason Need to use custom permission handling to give players usable commands
	  * Overwrite method to Check if the sender has permission for the commands
	  */
	@Overwrite
	public void sendCommands(ServerPlayerEntity p_197051_1_) {
		...
		fillUsableCommandsNodes(ServerLifecycleHooks.getCurrentServer().getCommands().getDispatcher().getRoot(), rootcommandnode, p_197051_1_.createCommandSourceStack(), map, "", new Boolean(false));
