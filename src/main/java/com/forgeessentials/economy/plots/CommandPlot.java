...
public class CommandPlot extends ForgeEssentialsCommandBuilder
{
    ...
    public LiteralArgumentBuilder<CommandSource> setExecution()
    {
        return baseBuilder
                .then(Commands.literal("list")
                        .then(Commands.literal("own").executes(CommandContext -> execute(CommandContext, "list-own")))
                        .then(Commands.literal("sale").executes(CommandContext -> execute(CommandContext, "list-sale")))
                        .then(Commands.literal("all").executes(CommandContext -> execute(CommandContext, "list-all"))))
                .then(Commands.literal("define").executes(CommandContext -> execute(CommandContext, "define-0")))
                .then(Commands.literal("claim").executes(CommandContext -> execute(CommandContext, "claim-0")))
                .then(Commands.literal("set").then(Commands.literal("price")
                        ...
                        .then(Commands.argument("amount", IntegerArgumentType.integer())
                                .executes(CommandContext -> execute(CommandContext,
                                        "set-price-" + Integer
                                                .toString(IntegerArgumentType.getInteger(CommandContext, "amount"))))))
                        .then(Commands.literal("fee").executes(CommandContext -> execute(CommandContext, "set-fee"))
                                .then(Commands.argument("amount", IntegerArgumentType.integer()).then(Commands
                                        .argument("timeout", IntegerArgumentType.integer())
                                        .executes(CommandContext -> execute(CommandContext, "set-fee-" + Integer
                                                .toString(IntegerArgumentType.getInteger(CommandContext, "amount"))
                                                + "-"
                                                + Integer.toString(
                                                        IntegerArgumentType.getInteger(CommandContext, "timeout")))))))
                        .then(Commands.literal("name")
                                .then(Commands.argument("name", StringArgumentType.word())
                                        .executes(CommandContext -> execute(CommandContext,
                                                "set-name-" + StringArgumentType.getString(CommandContext, "name")))))
                        .then(Commands.literal("owner").then(Commands.argument("player", StringArgumentType.word())
                                .executes(CommandContext -> execute(CommandContext,
                                        "set-owner-" + StringArgumentType.getString(CommandContext, "player"))))))
                .then(Commands.literal("guestperms").executes(CommandContext -> execute(CommandContext, "guestperms-0"))
                        .then(Commands.argument("type", StringArgumentType.string()).suggests(SUGGEST_PermTypes)
                                .then(Commands.literal("allow")
                                        .executes(CommandContext -> execute(CommandContext,
                                                "guestperms-" + StringArgumentType.getString(CommandContext, "type")
                                                        + "-allow")))
                                .then(Commands.literal("deny")
                                        .executes(CommandContext -> execute(CommandContext,
                                                "guestperms-" + StringArgumentType.getString(CommandContext, "type")
                                                        + "-deny")))))
                .then(Commands.literal("select").executes(CommandContext -> execute(CommandContext, "select-0"))).then(
                        Commands.literal("userperms").executes(CommandContext -> execute(CommandContext, "userperms-0"))
                                .then(Commands
                                        .argument("type", StringArgumentType.string()).suggests(SUGGEST_PermTypes).then(
                                                Commands.literal("allow")
                                                        .executes(CommandContext -> execute(CommandContext,
                                                                "userperms-" + StringArgumentType
                                                                        .getString(CommandContext, "type") + "-allow")))
                                        .then(Commands.literal("deny").executes(CommandContext -> execute(
                                                CommandContext,
                                                "userperms-" + StringArgumentType.getString(CommandContext, "type")
                                                        + "-deny")))))
                .then(Commands.literal("mods").executes(CommandContext -> execute(CommandContext, "mods-0"))
                        .then(Commands.literal("add")
                                .then(Commands.argument("player", StringArgumentType.word())
                                        .executes(CommandContext -> execute(CommandContext,
                                                "mods-add-" + StringArgumentType.getString(CommandContext, "player")))))
                        .then(Commands.literal("remove").then(Commands.argument("player", StringArgumentType.word())
                                .executes(CommandContext -> execute(CommandContext,
                                        "mods-remove-" + StringArgumentType.getString(CommandContext, "player")))))

                )
                .then(Commands.literal("users").executes(CommandContext -> execute(CommandContext, "users-0"))
                        .then(Commands.literal("add").then(Commands.argument("player", StringArgumentType.word())
                                .executes(CommandContext -> execute(CommandContext,
                                        "users-add-" + StringArgumentType.getString(CommandContext, "player")))))
                        .then(Commands.literal("remove").then(Commands.argument("player", StringArgumentType.word())
                                .executes(CommandContext -> execute(CommandContext,
                                        "users-remove-" + StringArgumentType.getString(CommandContext, "player"))))))
                .then(Commands.literal("limits").executes(CommandContext -> execute(CommandContext, "limits-0")))
                .then(Commands.literal("buy").executes(CommandContext -> execute(CommandContext, "buy-0"))
                        .then(Commands.argument("amount", LongArgumentType.longArg())
                                .executes(CommandContext -> execute(CommandContext,
                                        "buy-" + Long.toString(LongArgumentType.getLong(CommandContext, "amount"))))))
                .then(Commands.literal("sell").executes(CommandContext -> execute(CommandContext, "sell-0")))
                .then(Commands.literal("delete").executes(CommandContext -> execute(CommandContext, "delete-0")))
    ...
    public int processCommandPlayer(CommandContext<CommandSource> ctx, String params) throws CommandSyntaxException
    {
        if (params.equals("help"))
        {
            ...
            ChatOutputHandler.chatConfirmation(ctx.getSource(), Translator.translate(
    ...
    public void parseDefine(CommandContext<CommandSource> ctx) throws CommandException
    {
    ...
    public void parseDelete(CommandContext<CommandSource> ctx) throws CommandException
    {
        ...
        if (plot.getOwner() == UserIdent.get((ServerPlayerEntity) ctx.getSource().getEntity())
                || APIRegistry.perms.checkPermission((PlayerEntity) ctx.getSource().getEntity(), Plot.PERM_DELETE))
        {
            ChatOutputHandler.chatConfirmation(ctx.getSource(),
                    Translator.format("Plot \"%s\" has been deleted.", plot.getNameNotNull()));
    ...
    public void parseClaim(final CommandContext<CommandSource> ctx) throws CommandException
    {
            ...
            public void respond(Boolean response)
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        ChatOutputHandler.chatConfirmation(ctx.getSource(),
                                Translator.format("Plot created for %s!", APIRegistry.economy.toString(price)));
                    }
                    catch (EventCancelledException e)
                    {
                        ChatOutputHandler.chatError(ctx.getSource(), "Plot creation cancelled");
    ...
    private void checkLimits(CommandContext<CommandSource> ctx, WorldArea newArea) throws CommandException
    {
        ...
        int limitCount = ServerUtil.parseIntDefault(
                APIRegistry.perms.getUserPermissionProperty(getIdent(ctx.getSource()), Plot.PERM_LIMIT_COUNT),
                Integer.MAX_VALUE);
        int limitSize = ServerUtil.parseIntDefault(
                APIRegistry.perms.getUserPermissionProperty(getIdent(ctx.getSource()), Plot.PERM_LIMIT_SIZE),
                Integer.MAX_VALUE);
        int usedCount = 0;
        long usedSize = 0;
        ...
        {
            ChatOutputHandler.chatError(ctx.getSource(), "You have reached your limit of %s plots already!",
                    limitCount);
            return;
        }
        if (usedSize + plotSize > limitSize)
        {
            ChatOutputHandler.chatError(ctx.getSource(), "You have reached your limit of %s blocks^2 already!",
                    limitSize);
            return;
        }
    }

    public void parseList(final CommandContext<CommandSource> ctx, List<String> params) throws CommandException
    {
        ...
        final WorldPoint playerRef = (ServerPlayerEntity) ctx.getSource().getEntity() != null
                ? new WorldPoint(((ServerPlayerEntity) ctx.getSource().getEntity()).getLevel(),
        ...
        ChatOutputHandler.chatConfirmation(ctx.getSource(),
                Translator.translate("Listing " + listType.toString().toLowerCase() + " plots:"));
        for (Plot plot : plots)
            plot.printInfo(ctx.getSource());
    }

    public void parseLimits(CommandContext<CommandSource> ctx) throws CommandException
    {
        String limitCount = APIRegistry.perms.getUserPermissionProperty(getIdent(ctx.getSource()),
                Plot.PERM_LIMIT_COUNT);
        ...
        ChatOutputHandler.chatConfirmation(ctx.getSource(),
                Translator.format("You used %d of %s allowed plot count.", usedCount, limitCount));
        ChatOutputHandler.chatConfirmation(ctx.getSource(),
                Translator.format("You used %d of %s allowed plot size.", usedSize, limitSize));
    }

    public void parseSelect(CommandContext<CommandSource> ctx) throws CommandException
    {
        Plot plot = getPlot(ctx.getSource());
        if (plot == null)
        {
        ...
        SelectionHandler.select((ServerPlayerEntity) ctx.getSource().getEntity(), plot.getDimension(),
                plot.getZone().getArea());
        ChatOutputHandler.chatConfirmation(ctx.getSource(), "Selected plot");
    }

    public void parseMods(CommandContext<CommandSource> ctx, List<String> params, boolean modifyUsers)
            throws CommandException
    {
        ...
        {
            ChatOutputHandler.chatConfirmation(ctx.getSource(),
                    "/plot " + type + " add|remove <player>: Add / remove " + type);
        ...
        case "add":
            ...
            ChatOutputHandler.chatConfirmation(ctx.getSource(),
                    Translator.format("Added %s to plot " + type, player.getUsernameOrUuid()));
            break;
        case "remove":
            plot.getZone().removePlayerFromGroup(player, modifyUsers ? Plot.GROUP_PLOT_USER : Plot.GROUP_PLOT_MOD);
            ChatOutputHandler.chatConfirmation(ctx.getSource(),
                    Translator.format("Removed %s from plot " + type, player.getUsernameOrUuid()));
            break;
        default:
    ...
    public void parseSet(CommandContext<CommandSource> ctx, List<String> params) throws CommandException
    {
        if (params.isEmpty())
        {
            ...
            if (APIRegistry.perms.checkPermission((PlayerEntity) ctx.getSource().getEntity(), Plot.PERM_SET_FEE))
                ChatOutputHandler.chatConfirmation(ctx.getSource(),
                        Translator.translate("/plot set fee: Set a fee (WIP)")); // TODO WIP plots
    ...
    public void parseSetPrice(CommandContext<CommandSource> ctx, List<String> params) throws CommandException
    {
        Plot plot = getPlot(ctx.getSource());
        if (plot == null)
        {
        ...
        if (params.isEmpty())
        {
            ...
            if (price >= 0)
                ChatOutputHandler.chatConfirmation(ctx.getSource(),
                        Translator.format("Current plot price: %s", APIRegistry.economy.toString(price)));
            else
        ...
        if (price >= 0)
        {
            plot.setPrice(price);
            ChatOutputHandler.chatConfirmation(ctx.getSource(),
                    Translator.format("Put up plot for sale for %s", APIRegistry.economy.toString(price)));
        }
        else
        {
            plot.setPrice(-1);
    ...
    public void parseSetFee(CommandContext<CommandSource> ctx, List<String> params) throws CommandException
    {
        Plot plot = getPlot(ctx.getSource());
        if (plot == null)
        {
        ...
        if (params.isEmpty())
        {
            if (APIRegistry.perms.checkPermission((PlayerEntity) ctx.getSource().getEntity(), Plot.PERM_SET_FEE))
                ChatOutputHandler.chatConfirmation(ctx.getSource(),
                        Translator.translate("/plot set fee <amount> <timeout>: Set fee (WIP)")); // TODO WIP
            // plots
            ChatOutputHandler.chatConfirmation(ctx.getSource(),
                    Translator.format("Current plot fee: %s", APIRegistry.economy.toString(plot.getFee())));
            return;
        }
        ...
        ChatOutputHandler.chatConfirmation(ctx.getSource(), Translator.format("Set plot price to %s and timeout to %d",
                APIRegistry.economy.toString(amount), timeout));
    }

    public void parseSetName(CommandContext<CommandSource> ctx, List<String> params) throws CommandException
    {
        Plot plot = getPlot(ctx.getSource());
        if (plot == null)
        {
    ...
    public void parseSetOwner(CommandContext<CommandSource> ctx, List<String> params) throws CommandException
    {
        Plot plot = getPlot(ctx.getSource());
        if (plot == null)
        {
        ...
        if (params.isEmpty())
        {
            if (APIRegistry.perms.checkPermission((PlayerEntity) ctx.getSource().getEntity(), Plot.PERM_SET_OWNER))
            {
                ...
                ChatOutputHandler.chatConfirmation(ctx.getSource(), "/plot set owner "
                        + APIRegistry.IDENT_SERVER.getUsernameOrUuid() + ": Set plot owner to server");
            }
            UserIdent owner = plot.getOwner();
            if (owner == null)
                owner = APIRegistry.IDENT_SERVER;
            ChatOutputHandler.chatConfirmation(ctx.getSource(),
                    Translator.format("Current plot owner: %s", owner.getUsernameOrUuid()));
            return;
        }
        UserIdent newOwner;
        try
        ...
        ChatOutputHandler.chatConfirmation(ctx.getSource(),
                Translator.format("Set plot owner to \"%s\"", newOwner.getUsernameOrUuid()));
    }

    public void parsePerms(CommandContext<CommandSource> ctx, List<String> params, boolean userPerms)
            throws CommandException
    {
        ...
        {
            ChatOutputHandler.chatConfirmation(ctx.getSource(),
                    "/plot perms <type> true|false: Control what other players can do in a plot");
            ChatOutputHandler.chatConfirmation(ctx.getSource(),
                    Translator.format("Possible perms: %s", StringUtils.join(tabCompletion, ", ")));
            return;
        }
        ...
        case "interact":
            ...
            break;
        case "chest":
            plot.setPermission(ModuleProtection.getBlockBreakPermission(Blocks.CHEST) + Zone.ALL_PERMS, userPerms,
                    allow);
            plot.setPermission(ModuleProtection.getBlockBreakPermission(Blocks.CHEST) + Zone.ALL_PERMS, userPerms,
                    allow);
            plot.setPermission(ModuleProtection.getBlockInteractPermission(Blocks.CHEST) + Zone.ALL_PERMS, userPerms,
                    allow);
            plot.setPermission(ModuleProtection.getBlockBreakPermission(Blocks.TRAPPED_CHEST) + Zone.ALL_PERMS,
                    userPerms, allow);
            plot.setPermission(ModuleProtection.getBlockInteractPermission(Blocks.TRAPPED_CHEST) + Zone.ALL_PERMS,
                    userPerms, allow);
            ChatOutputHandler.chatConfirmation(ctx.getSource(), msgBase + "to interact with chests");
            break;
        case "button":
            plot.setPermission(ModuleProtection.getBlockInteractPermission(Blocks.ACACIA_BUTTON) + Zone.ALL_PERMS,
                    userPerms, allow);
            plot.setPermission(ModuleProtection.getBlockInteractPermission(Blocks.BIRCH_BUTTON) + Zone.ALL_PERMS,
                    userPerms, allow);
            plot.setPermission(ModuleProtection.getBlockInteractPermission(Blocks.CRIMSON_BUTTON) + Zone.ALL_PERMS,
                    userPerms, allow);
            plot.setPermission(ModuleProtection.getBlockInteractPermission(Blocks.DARK_OAK_BUTTON) + Zone.ALL_PERMS,
                    userPerms, allow);
            plot.setPermission(ModuleProtection.getBlockInteractPermission(Blocks.JUNGLE_BUTTON) + Zone.ALL_PERMS,
                    userPerms, allow);
            plot.setPermission(ModuleProtection.getBlockInteractPermission(Blocks.OAK_BUTTON) + Zone.ALL_PERMS,
                    userPerms, allow);
            plot.setPermission(ModuleProtection.getBlockInteractPermission(Blocks.SPRUCE_BUTTON) + Zone.ALL_PERMS,
                    userPerms, allow);
            plot.setPermission(ModuleProtection.getBlockInteractPermission(Blocks.WARPED_BUTTON) + Zone.ALL_PERMS,
                    userPerms, allow);
            plot.setPermission(ModuleProtection.getBlockInteractPermission(Blocks.STONE_BUTTON) + Zone.ALL_PERMS,
                    userPerms, allow);
            plot.setPermission(
                    ModuleProtection.getBlockInteractPermission(Blocks.POLISHED_BLACKSTONE_BUTTON) + Zone.ALL_PERMS,
                    userPerms, allow);
            ChatOutputHandler.chatConfirmation(ctx.getSource(), msgBase + "to interact with buttons");
            break;
        case "lever":
            plot.setPermission(ModuleProtection.getBlockInteractPermission(Blocks.LEVER) + Zone.ALL_PERMS, userPerms,
                    allow);
            ChatOutputHandler.chatConfirmation(ctx.getSource(), msgBase + "to interact with levers");
            break;
        case "door":
            plot.setPermission(ModuleProtection.getBlockInteractPermission(Blocks.ACACIA_DOOR) + Zone.ALL_PERMS,
                    userPerms, allow);
            plot.setPermission(ModuleProtection.getBlockInteractPermission(Blocks.BIRCH_DOOR) + Zone.ALL_PERMS,
                    userPerms, allow);
            plot.setPermission(ModuleProtection.getBlockInteractPermission(Blocks.CRIMSON_DOOR) + Zone.ALL_PERMS,
                    userPerms, allow);
            plot.setPermission(ModuleProtection.getBlockInteractPermission(Blocks.DARK_OAK_DOOR) + Zone.ALL_PERMS,
                    userPerms, allow);
            plot.setPermission(ModuleProtection.getBlockInteractPermission(Blocks.JUNGLE_DOOR) + Zone.ALL_PERMS,
                    userPerms, allow);
            plot.setPermission(ModuleProtection.getBlockInteractPermission(Blocks.OAK_DOOR) + Zone.ALL_PERMS, userPerms,
                    allow);
            plot.setPermission(ModuleProtection.getBlockInteractPermission(Blocks.OAK_DOOR) + Zone.ALL_PERMS, userPerms,
                    allow);
            plot.setPermission(ModuleProtection.getBlockInteractPermission(Blocks.WARPED_DOOR) + Zone.ALL_PERMS,
                    userPerms, allow);

            ChatOutputHandler.chatConfirmation(ctx.getSource(),
                    Translator.translate(msgBase + "to interact with doors"));
            break;
        case "animal":
    ...
    public void parseBuyStart(final CommandContext<CommandSource> ctx, List<String> params)
            throws CommandException
    {
        ...
        if (!params.isEmpty())
        {
            ...
            if (sellPrice >= 0 && sellPrice < buyPrice)
                ChatOutputHandler.chatNotification(ctx.getSource(),
                        Translator.format("%s is above the plots default price of %s",
                                APIRegistry.economy.toString(buyPrice), APIRegistry.economy.toString(sellPrice)));
        }
        else
        {
            if (sellPrice >= 0)
        ...
        if (!plot.hasOwner())
        {
            ...
            {
                ChatOutputHandler.chatError(ctx.getSource(), Translator.format("The fixed price of this plot is %s.",
        ...
        QuestionerCallback handler = new QuestionerCallback() {
            ...
            public void respond(Boolean response) throws CommandException
            {
                ...
                if (sellPrice < 0 || sellPrice > buyPrice)
                {
                    ...
                    {
                        ChatOutputHandler.chatError(ctx.getSource(),
                                "You cannot buy this plot because the owner is not online.");
                        return;
                    }
                    ...
                    if (buyPrice < sellPrice && sellPrice >= 0)
                        message += " \u00a7c" + Translator.format("This is below the price of %s you set up!",
                                APIRegistry.economy.toString(sellPrice));
                    if (buyPrice < plotPrice)
                        message += " \u00a7c" + Translator.format("This is below the plots value of %s!",
                                APIRegistry.economy.toString(sellPrice));
                    ...
                    QuestionerCallback handler = new QuestionerCallback() {
                        ...
                        public void respond(Boolean response) throws CommandException
                        {
                            ...
                            else if (response == false)
                            {
                                ...
                                ChatOutputHandler.chatError(ctx.getSource(),
                                        Translator.format("%s declined to sell you plot \"%s\" for %s", //
    ...
    public void buyPlot(CommandContext<CommandSource> ctx, Plot plot, long price) throws CommandException
    {
        ...
        if (plot.hasOwner())
        {
            ...
            {
                ChatOutputHandler.chatConfirmation(plot.getOwner().getPlayerMP(),
                        Translator.format("You sold plot \"%s\" to %s for %s", plot.getName(),
                                ctx.getSource().getEntity().getDisplayName().getString(), priceStr));
        ...
        {
            ChatOutputHandler.chatConfirmation(ctx.getSource(),
                    Translator.format("You bought plot \"%s\" from the server for %s", plot.getName(), priceStr));
            ModuleEconomy.confirmNewWalletAmount(getIdent(ctx.getSource()), buyerWallet);
        }
    ...
    public Plot getPlot(CommandSource sender) throws CommandException
    {
