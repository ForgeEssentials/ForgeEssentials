...
public class Data
{
	...
	protected static String[]	transformers	= { "com.ForgeEssentials.coremod.FEPermissionsTransformer", "com.ForgeEssentials.coremod.transformers.FEAccessTransformer" , "com.ForgeEssentials.coremod.transformers.FEeventAdder"};
