...
public interface IModuleConfig
{
	...
	/**
	 * this should check the generate boolean and do stuff accordingly.
	 * it should either load, or generate. 
	 */
	public void init();
	...
	/**
	 * This is called on the reload command. Ensure that it sets everything where needed.
	 * The sender is provided to spit any errors to if wanted.
	 */
