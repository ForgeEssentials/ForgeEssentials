...
{
	public static boolean onBlockHarvested(World world, int x, int y, int z,
			Block block, int metadata, EntityPlayer player)
	{
	...
	public static boolean onBlockPlace(ItemStack itemStack,
			EntityPlayer player, World world, int x, int y, int z, int side,
			float hitx, float hity, float hitz)
	{
		PlayerBlockPlace ev = new PlayerBlockPlace(itemStack, player, world, x,
