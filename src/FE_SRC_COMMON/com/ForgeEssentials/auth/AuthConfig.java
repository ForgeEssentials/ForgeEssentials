...
public class AuthConfig extends ModuleConfigBase
{
	...
	public void init()
	{
		...
		ModuleAuth.salt = config.get(CATEGORY_MAIN, "allowOfflineReg", ModuleAuth.salt, "The salt to be used when hashing passwords").value;
	...
	public void forceSave()
	{
		...
		config.get(CATEGORY_MAIN, "allowOfflineReg", "", "The salt to be used when hashing passwords").value = ModuleAuth.salt;
	...
	public void forceLoad(ICommandSender sender)
	{
		...
		ModuleAuth.salt = config.get(CATEGORY_MAIN, "allowOfflineReg", ModuleAuth.salt).value;
	}
