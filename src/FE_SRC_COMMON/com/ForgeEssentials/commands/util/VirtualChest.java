...
public class VirtualChest extends InventoryBasic
{
    ...
    {
		loadInventoryFromNBT(owner.getEntityData().getCompoundTag(owner.PERSISTED_NBT_TAG).getTagList("VirtualChestItems"));
        super.openChest();
    }
    ...
    {
    	NBTTagCompound temp = owner.getEntityData().getCompoundTag(owner.PERSISTED_NBT_TAG);
    	temp.setTag("VirtualChestItems", saveInventoryToNBT());
    	owner.getEntityData().setCompoundTag(owner.PERSISTED_NBT_TAG, temp);
    	super.closeChest();
    }
