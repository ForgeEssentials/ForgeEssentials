...
public class ConfigCmd implements IModuleConfig
{
	...
	public void forceSave()
	{
		...
		config.addCustomCategoryComment("general", "General Commands configuration.");
		config.get("general", "removeDuplicateCommands", true, "Remove commands from the list if they already exist outside of FE.").value = "" + ModuleCommands.removeDuplicateCommands;
		...
		config.get("general", "useVirtualChestAlias", true, "Use the alias '/vchest' for the command '/virtualchest'.").value = "" + CommandVirtualchest.useAlias;
