...
public class CommandBackup extends ForgeEssentialsCommandBase
{
	...
	public void processCommandConsole(ICommandSender sender, String[] args)
	{
		...
		if (svr.isDedicatedServer())
			source = (new File(svr.getFolderName())).getAbsolutePath() + File.separator;
		else
			source = new File("saves" + File.separator + svr.getFolderName()).getAbsolutePath() + File.separator;
		...
		output = backupName.replaceAll("%day", day.toString()).replaceAll("%month", month.toString()).replaceAll("%year", year.toString()).replaceAll("%hour", hour.toString()).replaceAll("%min", min.toString()).replaceAll("%world", svr.getFolderName());
