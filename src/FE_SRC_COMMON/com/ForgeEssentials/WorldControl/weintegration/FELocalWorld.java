...
public class FELocalWorld extends LocalWorld
{
	...
	{
		if (arg0 instanceof FELocalWorld)
			return ((FELocalWorld) arg0).world.equals(world);
		else
			return false;
	}
	...
	public BiomeType getBiome(Vector2D arg0)
	{
		try
		{
			return WEIntegration.serverInterface.getBiomes().get(world.getBiomeGenForCoords(arg0.getBlockX(), arg0.getBlockZ()).biomeName);
		}
		catch (Throwable e)
		{
			e.printStackTrace();
	...
	public boolean generateTree(TreeType arg0, EditSession arg1, Vector arg2)
	{
		switch (arg0)
			{
				case BIRCH:
					return new WorldGenForest(true).generate(world, world.rand, arg2.getBlockX(), arg2.getBlockY(), arg2.getBlockZ());
				case REDWOOD:
					return new WorldGenTrees(true, 4 + world.rand.nextInt(7), 3, 3, false).generate(world, world.rand, arg2.getBlockX(), arg2.getBlockY(), arg2.getBlockZ());
				case BIG_TREE:
					return new WorldGenHugeTrees(true, 10 + world.rand.nextInt(20), 3, 3).generate(world, world.rand, arg2.getBlockX(), arg2.getBlockY(), arg2.getBlockZ());
				case BROWN_MUSHROOM:
					return new WorldGenBigMushroom(0).generate(world, world.rand, arg2.getBlockX(), arg2.getBlockY(), arg2.getBlockZ());
				case RED_MUSHROOM:
					return new WorldGenBigMushroom(1).generate(world, world.rand, arg2.getBlockX(), arg2.getBlockY(), arg2.getBlockZ());
				default:
					return (world.rand.nextInt(10) == 0 ? new WorldGenBigTree(true) : new WorldGenTrees(true)).generate(world, world.rand, arg2.getBlockX(), arg2.getBlockY(), arg2.getBlockZ());
			}
	}
	...
	public LocalEntity[] getEntities(Region arg0)
	{
		...
		{
			ret.add(WEIntegration.getEntity(entity));
		}
