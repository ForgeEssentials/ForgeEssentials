...
public class CommandUser
{
	public static void processCommandPlayer(EntityPlayer sender, String[] args)
	{
		...
		{
			OutputHandler.chatError(sender,
					Localization.format(Localization.ERROR_NOPLAYER, args[0]));
		}
		...
		} else if (args[1].equalsIgnoreCase("supers")) // super perms management
		{
			...
			} else if (args.length >= 3) // changing super perms
			{
				if (args[2].equalsIgnoreCase("true")
						|| args[2].equalsIgnoreCase("allow")) // allowing super
																// perm
				{

				} else if (args[2].equalsIgnoreCase("clear")
						|| args[2].equalsIgnoreCase("remove")) // remove super
																// perm settings
				{

				} else if (args[2].equalsIgnoreCase("false")
						|| args[2].equalsIgnoreCase("deny")) // deny super perm
				{
		...
		} else if (args.length >= 3) // player management
		{
			if (args[1].equalsIgnoreCase("prefix")
					|| args[1].equalsIgnoreCase("suffix")) // prefix/suffix
															// changes
			{

			} else if (args[1].equalsIgnoreCase("true")
					|| args[1].equalsIgnoreCase("allow")) // allowing player
															// perm
			{

			} else if (args[1].equalsIgnoreCase("clear")
					|| args[1].equalsIgnoreCase("remove")) // remove perm
															// settings
			{

			} else if (args[1].equalsIgnoreCase("false")
					|| args[1].equalsIgnoreCase("deny")) // deny player perm
			{
	...
	public static void processCommandConsole(ICommandSender sender,
			String[] args)
	{
