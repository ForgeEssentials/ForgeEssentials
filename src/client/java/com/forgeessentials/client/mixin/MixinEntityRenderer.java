        ...
        if (entity != null)
        {
            if (this.mc.world != null)
            {
                ...
                List<?> list = this.mc.world.getEntitiesWithinAABBExcludingEntity(entity,
                        entity.getEntityBoundingBox().expand(vec31.x * maxReach, vec31.y * maxReach, vec31.z * maxReach).expand(f1, f1, f1));
                ...
                if (this.pointedEntity != null && vec33 != null && (d2 < blockDistance || this.mc.objectMouseOver == null))
                {
