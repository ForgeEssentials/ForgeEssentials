...
public class WorldTypeMultiworld // extends WorldType
{
	...
	/**
	 * Creates the GenLayerBiome used for generating the world with the
	 * specified ChunkProviderSettings JSON String *IF AND ONLY IF* this
	 ...
	 *            The JSON string to use when initializing
	...
	public GenLayer getBiomeLayer(long worldSeed, GenLayer parentLayer,
		...
		return getBiomeLayer(worldSeed, parentLayer,
				ChunkGeneratorSettings.Factory
						.jsonToFactory(chunkProviderSettingsJson).build());
	}
