...
public class Multiworld
{
	...
	// EnumDifficulty difficulty = EnumDifficulty.PEACEFUL; // // protected
	// boolean allowHostileCreatures =
	...
	public void removeAllPlayersFromWorld() {
		ServerWorld overworld = ServerLifecycleHooks.getCurrentServer()
				.overworld();
	...
	public void updateWorldSettings() {
		if (!worldLoaded)
			return; // WorldServer worldServer = getWorldServer(); //
	...
	public static void teleport(ServerPlayerEntity player, ServerWorld world,
		...
		WarpPoint target = new WarpPoint(world.dimension(), x, y, z,
	...
	public static void displayDepartMessage(ServerPlayerEntity player) {
		  // String msg = player.world.provider.getDepartMessage(); // if (msg
		  == null) // msg = "Leaving the Overworld."; // if (player.dimension >
		  1 || player.dimension < -1) // msg += " (#" + player.dimension + ")";
	...
	public static void displayWelcomeMessage(ServerPlayerEntity player) {
		  // String msg = player.world.provider.getWelcomeMessage(); // if (msg
		  == null) // msg = "Entering the Overworld."; // if (player.dimension
		  > 1 || player.dimension < -1) // msg += " (#" + player.dimension +
		  ")"; // ChatOutputHandler.sendMessage(player, new
