...
public class BiomeMap {
	...
	public static final BiomeMap NULL = new BiomeMap(-1, "NULL", 0.5, 0.5,
			0xFFFFFF, 0, 0);
	...
	public static final BiomeMap EXTREME_HILLS = new BiomeMap(3,
	...
	public static final BiomeMap SWAMPLAND = new BiomeMap(6, "SWAMPLAND", 0.8,
			0.9, 0xE0FFAE, 0x4E0E4E, 0x4E0E4E);
	...
	public static final BiomeMap FROZEN_OCEAN = new BiomeMap(10, "FROZEN_OCEAN",
			0.0, 0.5);
	public static final BiomeMap FROZEN_RIVER = new BiomeMap(11, "FROZEN_RIVER",
			0.0, 0.5);
	public static final BiomeMap ICE_PLAINS = new BiomeMap(12, "ICE_PLAINS",
			0.0, 0.5);
	public static final BiomeMap ICE_MOUNTAINS = new BiomeMap(13,
			"ICE_MOUNTAINS", 0.0, 0.5);
	public static final BiomeMap MUSHROOM_ISLAND = new BiomeMap(14,
			"MUSHROOM_ISLAND", 0.9, 1.0);
	public static final BiomeMap MUSHROOM_SHORE = new BiomeMap(15,
			"MUSHROOM_SHORE", 0.9, 1.0);
	public static final BiomeMap BEACH = new BiomeMap(16, "BEACH", 0.8, 0.4);
	public static final BiomeMap DESERT_HILLS = new BiomeMap(17, "DESERT_HILLS",
			2.0, 0.0);
	public static final BiomeMap FOREST_HILLS = new BiomeMap(18, "FOREST_HILLS",
			0.7, 0.8);
	public static final BiomeMap TAIGA_HILLS = new BiomeMap(19, "TAIGA_HILLS",
			0.05, 0.8);
	public static final BiomeMap SMALL_MOUNTAINS = new BiomeMap(20,
			"SMALL_MOUNTAINS", 0.2, 0.8);
	public static final BiomeMap JUNGLE = new BiomeMap(21, "JUNGLE", 1.2, 0.9);
	public static final BiomeMap JUNGLE_HILLS = new BiomeMap(22, "JUNGLE_HILLS",
			1.2, 0.9);
	...
	public static void loadWellKnownByVersion(String mcver) {
		...
		new BiomeMap(134, "SWAMPLAND_MOUNTAINS", 0.8, 0.9, 0xE0FFAE, 0x4E0E4E,
				0x4E0E4E);
	...
	private BiomeMap(int idx, String id, double tmp, double rain,
			int waterColorMultiplier, int grassmult, int foliagemult) {
		/*
		 * Clamp values : we use raw values from MC code, which are clamped
		 * during color mapping only
		 */
		setTemperature(tmp);
		setRainfall(rain);
