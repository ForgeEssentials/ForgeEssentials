...
public class ModuleFactions
{
    ...
    public void load(FEModuleServerStartingEvent event)
    {
        ...
        APIRegistry.perms.registerPermission(PERM_DATA_LOCKED, DefaultPermissionLevel.NONE,
                "Locks a faction so players can only join on invitation");
        ...
        APIRegistry.perms.registerPermission(PERM_JOIN_ANY, DefaultPermissionLevel.OP,
                "Allows joining even locked factions");
        APIRegistry.perms.registerPermission(PERM_LEAVE, DefaultPermissionLevel.ALL, "Allows to leave factions");
        APIRegistry.perms.registerPermission(PERM_INVITE, DefaultPermissionLevel.ALL,
                "Allows inviting other players to a faction");
        ...
        APIRegistry.perms.registerPermission(PERM_FF, DefaultPermissionLevel.OP,
                "Allows controlling friendly fire setting");
        APIRegistry.perms.registerPermission(PERM_BONUS, DefaultPermissionLevel.OP,
                "Allows controlling faction bonuses");
    ...
    {
        event.serverZone.setGroupPermissionProperty(GROUP_OWNER, FEPermissions.GROUP_PRIORITY,
                Integer.toString(FEPermissions.GROUP_PRIORITY_DEFAULT - 2));
        event.serverZone.setGroupPermissionProperty(GROUP_OP, FEPermissions.GROUP_PRIORITY,
                Integer.toString(FEPermissions.GROUP_PRIORITY_DEFAULT - 4));
    }
